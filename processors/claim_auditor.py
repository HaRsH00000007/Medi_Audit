...
Your tasks:
  A. For EACH line item in the bill, produce one JSON row with these exact keys:
       "parameter"    – treatment / charge name
       "bill_detail"  – amount + description from bill
       "policy_clause"– matching policy rule (baseline or uploaded)
       "status"       – exactly one of: ✅  ⚠️  ❌
       "lag_reason"   – 1–2 sentence explanation; quantify monetary gaps
       "risk_score"   – integer 0–100 (0=no risk, 100=critical rejection)
